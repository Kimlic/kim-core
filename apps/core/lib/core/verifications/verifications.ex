defmodule Core.Verifications do
  ...
  defp verification_ttl(:phone), do: Application.get_env(:core, :verifications_ttl_phone)
  defp verification_ttl(:email), do: Application.get_env(:core, :verifications_ttl_email)
